...
### Design References
 ...
 - refer to the screenshots in the screenshots folder as UI reference. it does not need to be exact. Refer to @context/screenshots

 for the main dashboard ---> use dashboar-ui-main.png
 for the drawer --> use dashboard-ui-drawer.png
---
